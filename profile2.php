	...
	<div class="row">
      ...
      <div class="col-md-3">
        <div class="text-center">
          ...
          <form class="form-horizontal" role="form" action="updatephoto.php" method="post" enctype="multipart/form-data">
          <input type="file" class="form-control" style="margin-top:7.5%;" name="img-file" required /><br>
          <input type="submit" class="btn btn-secondary" value="Update Photo" />
          </form>
        </div>
      </div>
      ...
      <div class="col-md-9 personal-info">
       ...
       <form class="form-horizontal" role="form" action="profile2.php?q=0" method="post">
